...
```{r}
data_matrimonios_2010$DEPREG <- as.double(data_matrimonios_2010$DEPREG)
data_matrimonios_2011$DEPREG <- as.double(data_matrimonios_2011$DEPREG)
data_matrimonios_2012$DEPREG <- as.double(data_matrimonios_2012$DEPREG)
data_matrimonios_2013$DEPREG <- as.double(data_matrimonios_2013$DEPREG)
data_matrimonios_2014$DEPREG <- as.double(data_matrimonios_2014$DEPREG)
data_matrimonios_2015$DEPREG <- as.double(data_matrimonios_2015$DEPREG)
data_matrimonios_2016$DEPREG <- as.double(data_matrimonios_2016$DEPREG)
data_matrimonios_2017$DEPREG <- as.double(data_matrimonios_2017$DEPREG)
data_matrimonios_2018$DEPREG <- as.double(data_matrimonios_2018$DEPREG)
data_matrimonios_2019$DEPREG <- as.double(data_matrimonios_2019$DEPREG)
data_matrimonios_2020$DEPREG <- as.double(data_matrimonios_2020$DEPREG)
data_matrimonios_2021$DEPREG <- as.double(data_matrimonios_2021$DEPREG)
...
data_matrimonios_2010$MESREG <- as.double(data_matrimonios_2010$MESREG)
data_matrimonios_2011$MESREG <- as.double(data_matrimonios_2011$MESREG)
data_matrimonios_2012$MESREG <- as.double(data_matrimonios_2012$MESREG)
data_matrimonios_2013$MESREG <- as.double(data_matrimonios_2013$MESREG)
data_matrimonios_2014$MESREG <- as.double(data_matrimonios_2014$MESREG)
data_matrimonios_2015$MESREG <- as.double(data_matrimonios_2015$MESREG)
data_matrimonios_2016$MESREG <- as.double(data_matrimonios_2016$MESREG)
data_matrimonios_2017$MESREG <- as.double(data_matrimonios_2017$MESREG)
data_matrimonios_2018$MESREG <- as.double(data_matrimonios_2018$MESREG)
data_matrimonios_2019$MESREG <- as.double(data_matrimonios_2019$MESREG)
data_matrimonios_2020$MESREG <- as.double(data_matrimonios_2020$MESREG)
data_matrimonios_2021$MESREG <- as.double(data_matrimonios_2021$MESREG)

data_matrimonios_2010$CLAUNI <- as.double(data_matrimonios_2010$CLAUNI)
data_matrimonios_2011$CLAUNI <- as.double(data_matrimonios_2011$CLAUNI)
data_matrimonios_2012$CLAUNI <- as.double(data_matrimonios_2012$CLAUNI)
data_matrimonios_2013$CLAUNI <- as.double(data_matrimonios_2013$CLAUNI)
data_matrimonios_2014$CLAUNI <- as.double(data_matrimonios_2014$CLAUNI)
data_matrimonios_2015$CLAUNI <- as.double(data_matrimonios_2015$CLAUNI)
data_matrimonios_2016$CLAUNI <- as.double(data_matrimonios_2016$CLAUNI)
data_matrimonios_2017$CLAUNI <- as.double(data_matrimonios_2017$CLAUNI)
data_matrimonios_2018$CLAUNI <- as.double(data_matrimonios_2018$CLAUNI)
data_matrimonios_2019$CLAUNI <- as.double(data_matrimonios_2019$CLAUNI)
data_matrimonios_2020$CLAUNI <- as.double(data_matrimonios_2020$CLAUNI)
data_matrimonios_2021$CLAUNI <- as.double(data_matrimonios_2021$CLAUNI)
...
data_matrimonios_2010$GETHOM <- as.double(data_matrimonios_2010$GETHOM)
data_matrimonios_2011$GETHOM <- as.double(data_matrimonios_2011$GETHOM)
data_matrimonios_2012$GETHOM <- as.double(data_matrimonios_2012$GETHOM)
data_matrimonios_2013$GETHOM <- as.double(data_matrimonios_2013$GETHOM)
data_matrimonios_2014$GETHOM <- as.double(data_matrimonios_2014$GETHOM)
data_matrimonios_2015$GETHOM <- as.double(data_matrimonios_2015$GETHOM)
data_matrimonios_2016$GETHOM <- as.double(data_matrimonios_2016$GETHOM)
data_matrimonios_2017$GETHOM <- as.double(data_matrimonios_2017$GETHOM)
data_matrimonios_2018$GETHOM <- as.double(data_matrimonios_2018$GETHOM)
data_matrimonios_2019$GETHOM <- as.double(data_matrimonios_2019$GETHOM)
data_matrimonios_2020$GETHOM <- as.double(data_matrimonios_2020$GETHOM)
data_matrimonios_2021$GETHOM <- as.double(data_matrimonios_2021$GETHOM)

data_matrimonios_2010$GETMUJ <- as.double(data_matrimonios_2010$GETMUJ)
data_matrimonios_2011$GETMUJ <- as.double(data_matrimonios_2011$GETMUJ)
data_matrimonios_2012$GETMUJ <- as.double(data_matrimonios_2012$GETMUJ)
data_matrimonios_2013$GETMUJ <- as.double(data_matrimonios_2013$GETMUJ)
data_matrimonios_2014$GETMUJ <- as.double(data_matrimonios_2014$GETMUJ)
data_matrimonios_2015$GETMUJ <- as.double(data_matrimonios_2015$GETMUJ)
data_matrimonios_2016$GETMUJ <- as.double(data_matrimonios_2016$GETMUJ)
data_matrimonios_2017$GETMUJ <- as.double(data_matrimonios_2017$GETMUJ)
data_matrimonios_2018$GETMUJ <- as.double(data_matrimonios_2018$GETMUJ)
data_matrimonios_2019$GETMUJ <- as.double(data_matrimonios_2019$GETMUJ)
data_matrimonios_2020$GETMUJ <- as.double(data_matrimonios_2020$GETMUJ)
data_matrimonios_2021$GETMUJ <- as.double(data_matrimonios_2021$GETMUJ)

data_matrimonios_2010$NACHOM <- as.double(data_matrimonios_2010$NACHOM)
data_matrimonios_2011$NACHOM <- as.double(data_matrimonios_2011$NACHOM)
data_matrimonios_2012$NACHOM <- as.double(data_matrimonios_2012$NACHOM)
data_matrimonios_2013$NACHOM <- as.double(data_matrimonios_2013$NACHOM)
data_matrimonios_2014$NACHOM <- as.double(data_matrimonios_2014$NACHOM)
data_matrimonios_2015$NACHOM <- as.double(data_matrimonios_2015$NACHOM)
data_matrimonios_2016$NACHOM <- as.double(data_matrimonios_2016$NACHOM)
data_matrimonios_2017$NACHOM <- as.double(data_matrimonios_2017$NACHOM)
data_matrimonios_2018$NACHOM <- as.double(data_matrimonios_2018$NACHOM)
data_matrimonios_2019$NACHOM <- as.double(data_matrimonios_2019$NACHOM)
data_matrimonios_2020$NACHOM <- as.double(data_matrimonios_2020$NACHOM)
data_matrimonios_2021$NACHOM <- as.double(data_matrimonios_2021$NACHOM)

data_matrimonios_2010$NACMUJ <- as.double(data_matrimonios_2010$NACMUJ)
data_matrimonios_2011$NACMUJ <- as.double(data_matrimonios_2011$NACMUJ)
data_matrimonios_2012$NACMUJ <- as.double(data_matrimonios_2012$NACMUJ)
data_matrimonios_2013$NACMUJ <- as.double(data_matrimonios_2013$NACMUJ)
data_matrimonios_2014$NACMUJ <- as.double(data_matrimonios_2014$NACMUJ)
data_matrimonios_2015$NACMUJ <- as.double(data_matrimonios_2015$NACMUJ)
data_matrimonios_2016$NACMUJ <- as.double(data_matrimonios_2016$NACMUJ)
data_matrimonios_2017$NACMUJ <- as.double(data_matrimonios_2017$NACMUJ)
data_matrimonios_2018$NACMUJ <- as.double(data_matrimonios_2018$NACMUJ)
data_matrimonios_2019$NACMUJ <- as.double(data_matrimonios_2019$NACMUJ)
data_matrimonios_2020$NACMUJ <- as.double(data_matrimonios_2020$NACMUJ)
data_matrimonios_2021$NACMUJ <- as.double(data_matrimonios_2021$NACMUJ)

data_matrimonios_2010$ESCHOM <- as.double(data_matrimonios_2010$ESCHOM)
data_matrimonios_2011$ESCHOM <- as.double(data_matrimonios_2011$ESCHOM)
data_matrimonios_2012$ESCHOM <- as.double(data_matrimonios_2012$ESCHOM)
data_matrimonios_2013$ESCHOM <- as.double(data_matrimonios_2013$ESCHOM)
data_matrimonios_2014$ESCHOM <- as.double(data_matrimonios_2014$ESCHOM)
data_matrimonios_2015$ESCHOM <- as.double(data_matrimonios_2015$ESCHOM)
data_matrimonios_2016$ESCHOM <- as.double(data_matrimonios_2016$ESCHOM)
data_matrimonios_2017$ESCHOM <- as.double(data_matrimonios_2017$ESCHOM)
data_matrimonios_2018$ESCHOM <- as.double(data_matrimonios_2018$ESCHOM)
data_matrimonios_2019$ESCHOM <- as.double(data_matrimonios_2019$ESCHOM)
data_matrimonios_2020$ESCHOM <- as.double(data_matrimonios_2020$ESCHOM)
data_matrimonios_2021$ESCHOM <- as.double(data_matrimonios_2021$ESCHOM)


data_matrimonios_2010$ESCMUJ <- as.double(data_matrimonios_2010$ESCMUJ)
data_matrimonios_2011$ESCMUJ <- as.double(data_matrimonios_2011$ESCMUJ)
data_matrimonios_2012$ESCMUJ <- as.double(data_matrimonios_2012$ESCMUJ)
data_matrimonios_2013$ESCMUJ <- as.double(data_matrimonios_2013$ESCMUJ)
data_matrimonios_2014$ESCMUJ <- as.double(data_matrimonios_2014$ESCMUJ)
data_matrimonios_2015$ESCMUJ <- as.double(data_matrimonios_2015$ESCMUJ)
data_matrimonios_2016$ESCMUJ <- as.double(data_matrimonios_2016$ESCMUJ)
data_matrimonios_2017$ESCMUJ <- as.double(data_matrimonios_2017$ESCMUJ)
data_matrimonios_2018$ESCMUJ <- as.double(data_matrimonios_2018$ESCMUJ)
data_matrimonios_2019$ESCMUJ <- as.double(data_matrimonios_2019$ESCMUJ)
data_matrimonios_2020$ESCMUJ <- as.double(data_matrimonios_2020$ESCMUJ)
data_matrimonios_2021$ESCMUJ <- as.double(data_matrimonios_2021$ESCMUJ)


data_matrimonios_2010$DEPOCU <- as.double(data_matrimonios_2010$DEPOCU)
data_matrimonios_2011$DEPOCU <- as.double(data_matrimonios_2011$DEPOCU)
data_matrimonios_2012$DEPOCU <- as.double(data_matrimonios_2012$DEPOCU)
data_matrimonios_2013$DEPOCU <- as.double(data_matrimonios_2013$DEPOCU)
data_matrimonios_2014$DEPOCU <- as.double(data_matrimonios_2014$DEPOCU)
data_matrimonios_2015$DEPOCU <- as.double(data_matrimonios_2015$DEPOCU)
data_matrimonios_2016$DEPOCU <- as.double(data_matrimonios_2016$DEPOCU)
data_matrimonios_2017$DEPOCU <- as.double(data_matrimonios_2017$DEPOCU)
data_matrimonios_2018$DEPOCU <- as.double(data_matrimonios_2018$DEPOCU)
data_matrimonios_2019$DEPOCU <- as.double(data_matrimonios_2019$DEPOCU)
data_matrimonios_2020$DEPOCU <- as.double(data_matrimonios_2020$DEPOCU)
data_matrimonios_2021$DEPOCU <- as.double(data_matrimonios_2021$DEPOCU)
...
data_matrimonios_2010$MESOCU <- as.double(data_matrimonios_2010$MESOCU)
data_matrimonios_2011$MESOCU <- as.double(data_matrimonios_2011$MESOCU)
data_matrimonios_2012$MESOCU <- as.double(data_matrimonios_2012$MESOCU)
data_matrimonios_2013$MESOCU <- as.double(data_matrimonios_2013$MESOCU)
data_matrimonios_2014$MESOCU <- as.double(data_matrimonios_2014$MESOCU)
data_matrimonios_2015$MESOCU <- as.double(data_matrimonios_2015$MESOCU)
data_matrimonios_2016$MESOCU <- as.double(data_matrimonios_2016$MESOCU)
data_matrimonios_2017$MESOCU <- as.double(data_matrimonios_2017$MESOCU)
data_matrimonios_2018$MESOCU <- as.double(data_matrimonios_2018$MESOCU)
data_matrimonios_2019$MESOCU <- as.double(data_matrimonios_2019$MESOCU)
data_matrimonios_2020$MESOCU <- as.double(data_matrimonios_2020$MESOCU)
data_matrimonios_2021$MESOCU <- as.double(data_matrimonios_2021$MESOCU)
